...
from data.file_handling import create_note
from data.file_handling import update_note
from data.file_handling import display_notes
from data.file_handling import search_notes
